package com.geni.java.spring.chat.Ollama;
...
public class OllamaChatController {
    ...
    private static String SYSTEM_PROMPT="You are a helpful assistant that drafts professional and concise emails based on user input."+
            "Ensure the emails are clear, polite and tailored to the specified context." +
            "Use formal and respectful tone while maintaining brevity";
