package com.geni.java.spring.multimodality.imagetotext;
...
public class ProductController {
    ...
    public String uploadImageAndAnalyzeProductImage(@RequestPart("file")MultipartFile file, @RequestPart("description")String description)
    {
